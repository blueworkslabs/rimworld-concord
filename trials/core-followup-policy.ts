...
export function coreFollowupPolicy(id:string){
 ...
 if(id==='closure-followup-v1')return {...FOOD_FOLLOWUP_POLICY,scriptedNativeMs:30000,coreTrial:'closure-followup-core-v1' as const,pawnTrial:'closure-followup-pawns-v1' as const};
