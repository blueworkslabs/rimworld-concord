...
| Hauling migration | [Strict fallback](docs/trials/HAULING_MIGRATION_STRICT.md): Prior strict suite 15/16; mixed-item gap and rescue now pass targeted rechecks; both matched quotas complete | Growing parked, B1 2/2; one-map clock verified; wake-recipient policy and live/UI gates remain |
