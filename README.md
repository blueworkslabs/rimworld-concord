...
| Hauling migration | [Strict fallback](docs/trials/HAULING_MIGRATION_STRICT.md): Prior strict suite 15/16; mixed-item gap and rescue now pass targeted rechecks; both matched quotas complete | Merged strict; growing parked, B1 2/2; urgent-exempt wake rule verified; [single signed ordinary-play recording](docs/trials/HAULING_MIGRATION_LIVE.md) complete; recording-first read and Gate C verdict pending |
