...
| Native construction/cooking | [Gate A/B design](docs/MIGRATION_PRODUCTION.md) signed; corrected boundaries independently reviewed | [construction slice partially scripted-tested](docs/trials/NATIVE_CONSTRUCTION_REVIEW.md); cancellation/deconstruction and withdrawal checked; replacement/forced-queue coverage and full acceptance pending; cooking planned; no live freeze |
