...
| Hauling migration | [Strict fallback](docs/trials/HAULING_MIGRATION_STRICT.md): Prior strict suite 15/16; mixed-item gap and rescue now pass targeted rechecks; both matched quotas complete | Merged strict; growing parked, B1 2/2; urgent-exempt wake rule verified; [ordinary-play rehearsal/freeze](docs/trials/HAULING_MIGRATION_LIVE_FREEZE.md) ready for signature; no live migration verdict |
