...
| Hauling migration | [Strict fallback](docs/trials/HAULING_MIGRATION_STRICT.md): 15/16 scripted checks; both matched quotas complete | Growing parked, B1 2/2; mixed-item coverage and live/UI checks remain |
