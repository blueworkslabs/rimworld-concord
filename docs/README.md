...
| [MIGRATION_PRODUCTION](MIGRATION_PRODUCTION.md) | Construction/cooking: signed Gate A/B, source-reviewed boundary design; implementation and scripted acceptance next |
