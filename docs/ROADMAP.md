...
The [post-Gate-C follow-up verification](trials/POST_GATE_C_FOLLOWUPS.md) covers items 1–5, including core/reflection evidence matching their fitted inputs. Items 6 (bounded re-wake design) and 7 (eviction diagnosis) remain separate; this is not another live-model acceptance run.
