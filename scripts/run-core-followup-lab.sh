...
exec flock -n "$RIMWORLD_LAB_ROOT/concord/coordinator.lock" env CONCORD_CORE_FOLLOWUP_LOCKED=1 node "$concord_root/dist/trials/core-followup-game.js" "${concord_args[@]}"
