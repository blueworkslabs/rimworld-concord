...
exec flock -n "$RIMWORLD_LAB_ROOT/concord/coordinator.lock" env CONCORD_INTEGRATION_LOCKED=1 node "$concord_root/dist/trials/integration-game.js" "${concord_args[@]}"
