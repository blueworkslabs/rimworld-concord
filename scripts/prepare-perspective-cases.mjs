...
if(process.argv.length!==5)throw Error('Usage: prepare-perspective-cases CASES SOURCE-CATALOG LOCAL-CATALOG');
...
await writeFile(process.argv[2],JSON.stringify({version:bankVersion,authored:true,cases:preparedPerspectiveCases()},null,2),{flag:'wx',mode:0o600});
