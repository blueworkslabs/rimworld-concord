...
- Document unimplemented seams honestly: the appraisal adapter has mocked tests plus synthetic and bounded real-game live evidence, the attention consumer has bounded live appraisal, cancellation and completed-reflection evidence in paused and continuous modes, with paired/cold restore; a three-pawn authored-preference trial also completed counterproposal negotiation with a scripted core; this does not prove long-run character quality, and the OpenClaw adapter is not an installed integration. The in-game badge is implemented.
